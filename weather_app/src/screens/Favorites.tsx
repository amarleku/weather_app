...
function Favorites(){
    ...
    await fetch('https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/?unitGroup=metric&include=days&key=T8F4NJ3HKJVN9BQNVJLVMSGJE&contentType=json', {
        method: 'GET',
        headers: {
